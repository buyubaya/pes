...
class MyAccountTab extends React.Component {
    ...
    _renderInitialUpgradeProcess(isAdviser, isPA=false){
        const environment = EnvironmentUtils.get('environment');
    ...
    render(){
        ...
        let showUpgradingMessage = _.get(this.props, 'myProfile.userStatus.isUpgrading');
        ...
        return(
            ...
            {
                //check stage of upgrade process - Initial upgrade process
                showMyAccountMessage && showUpgradingMessage && 
                this._renderInitialUpgradeProcess(isAdviser, isPA)
