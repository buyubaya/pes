...
class GenericBond extends React.Component {
    static contextTypes = {
    ...
    render(){ 
        ...
        return (isServicingRole ? productGroup.toUpperCase() == ProductGroups.GB.toUpperCase() &&
            <div>
            ...
            </div> : productGroup.toUpperCase() == ProductGroups.GB.toUpperCase() &&
