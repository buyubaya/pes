...
export default class DistributionUtils {
    ...
    static DataRequest(form, plan) {
        ...
        let dataRequest = {
            ...
            distributionChangeType: form.distributionOption
        };
        if(form.distributionOption !== 'STOP'){
            _.assign(dataRequest,{                
                paymentType: form.paymentType,
                distributionPaymentType: form.paymentWhen
            });
