...
class GmfFundSummary extends React.Component {
    static contextTypes = {
    ...
    render(){
        ...
        let funds = get(this.context, 'plan.planDetail.funds');
                                        ...
                                        [
                                            <div className='col-xs-2 text-normal text-center cell-switchfund' key={0}>
                                                <LinkAuthority 
                                                    ...
                                                    {tabContent.switchFund}
                                                </LinkAuthority>
                                            </div>
                                            ,
                                            <div className='col-xs-3 text-normal text-center cell-surrender' key={1}>
                                                <LinkAuthority 
                                                    link={StringUtils.format(ServicingUrls.surrender, planId)} 
                                                    authority={clientAuthorised}
                                                    btnClassName='has-icon-arrow-right'
                                                    modalClassName='pes-modal pes-authority-modal'>
                                                    {tabContent.surrenderFullPartial}
                                                </LinkAuthority>
                                            </div>
                                        ]
                                    }
