            ...
            data => {
                ...
                .then(data => {
                    this.props.actions.getUserValidationStatusSuccess({
                        ...data, 
                        isValidating: UserValidationStatusUtils.isValidating(data), 
                        isValidated: UserValidationStatusUtils.isValidated(data), 
                        showMyAccountMessage: true
                    });
                })
                .catch(error => {
                    throw new SubmissionError({_error: (error && error.toString) ? error.toString() : 'Internal error'});
                });
            },
